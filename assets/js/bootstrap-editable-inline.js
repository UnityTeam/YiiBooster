...
(function ($) {
    ...
    //form template
    $.fn.editableform.template = '<form class="form-inline editableform"><div class="control-group">' + 
    '&nbsp;<button type="submit" class="btn btn-primary"><i class="glyphicon-ok icon-white"></i></button>&nbsp;<button type="button" class="btn clearfix"><i class="glyphicon-ban-circle"></i></button>' + 
